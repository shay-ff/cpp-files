...
x and 
y, there are three cards with 
x written on them and two cards with 
y written on them.
*/
void pre_pro(){
}
void dxt(int test_case){
    ...
    if(sz(mp) == 2){
        ...
        sort(all(ar));
        if(ar[0] == 2 and ar[1] == 2 || ar[0] == 1 and ar[1] == 3){
            show("Yes");
            return;
        }
    }
