...
/*
Two cells are adjacent to each other if they share a border or a corner, as shown in the following illustration. Formally, if (𝑟,𝑐)
 denotes the cell in the 𝑟
-th row and 𝑐
-th column, then cell (𝑟,𝑐)
 is adjacent to cell (𝑟,𝑐+1)
, (𝑟−1,𝑐+1)
, (𝑟−1,𝑐)
, (𝑟−1,𝑐−1)
, (𝑟,𝑐−1)
